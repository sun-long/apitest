...
class ApiTask(TaskSet):
    ...
    def ocr_idcrad(self):
        ...
        base64_image=str(BaseApi.imageToBase64(f"/Users/weishuting/code/gitlab.sz.sensetime.com/cloud/new_apitest/apitest/image/ocr/bankcard/performance_bankcrad_small.jpg"))
        # base64_image=str(BaseApi.imageToBase64(f"/Users/weishuting/code/gitlab.sz.sensetime.com/cloud/new_apitest/apitest/image/ocr/bankcard/performance_bankcrad_big.jpg"))
        # body={
        #             "encrypt_info": {

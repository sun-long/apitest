...
class ApiTask(TaskSet):
    ...
    def ocr_idcrad(self):
        ...
        headers = {
            "X-Belt-Action": "OCRTaiwanExitEntryPermit",
            "X-Request-ID": "test1",
        ...
        # base64_image=str(BaseApi.imageToBase64(f"/Users/weishuting/code/gitlab.sz.sensetime.com/cloud/new_apitest/apitest/image/ocr/taiwan_exit_entry_permit/performance_taiwan_exit_entry_permit_small.jpeg"))
        base64_image=str(BaseApi.imageToBase64(f"/Users/weishuting/code/gitlab.sz.sensetime.com/cloud/new_apitest/apitest/image/ocr/taiwan_exit_entry_permit/performance_taiwan_exit_entry_permit_big.jpeg"))
        body={
                    "encrypt_info": {

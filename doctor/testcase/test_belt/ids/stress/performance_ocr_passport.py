...
class ApiTask(TaskSet):
    ...
    def ocr_idcrad(self):
        ...
        # base64_image=str(BaseApi.imageToBase64(f"/Users/weishuting/code/gitlab.sz.sensetime.com/cloud/new_apitest/apitest/image/ocr/passport/performance_passport_small.jpeg"))
        base64_image=str(BaseApi.imageToBase64(f"/Users/weishuting/code/gitlab.sz.sensetime.com/cloud/new_apitest/apitest/image/ocr/passport/performance_passport_big.jpeg"))
        body={
                    "encrypt_info": {

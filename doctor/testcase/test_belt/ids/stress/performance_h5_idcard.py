...
class ApiTask(TaskSet):
    ...
    def ocr_idcrad(self):
        ...
        headers = {
            "X-Belt-Action": "H5OCRIDCard",
            "X-Request-ID": "test1",
            "X-Belt-Signature": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiIySXN5SDZqSkRFNTNWelVNcGk4RmRRdjFZQU8iLCJleHAiOjE2NzEyMjU2MDYsIm5iZiI6MTY3MTE4MjQwMX0.b7P7sdIUDlmFE5wiNXpgS-5novj-t6iVUwaizCkq8tY",
            "X-Belt-Version": "v1"
        }
        front_image_path="/Users/weishuting/code/gitlab.sz.sensetime.com/cloud/new_apitest/apitest/image/H5_front.jpg"
        back_image_path="/Users/weishuting/code/gitlab.sz.sensetime.com/cloud/new_apitest/apitest/image/H5_back.jpg"
        front_base64_image=str(BaseApi.imageToBase64(front_image_path))
        back_base64_image=str(BaseApi.imageToBase64(back_image_path))

        body={
        "front_image": front_base64_image,
        "back_image": back_base64_image,
        "encrypt_info": {

...
class ApiTask(TaskSet):
    ...
    def ocr_idcrad(self):
        ...
        headers = {
            "X-Belt-Action": "OCRBusinessLicense",
            "X-Request-ID": "test1",
        ...
        base64_image=str(BaseApi.imageToBase64(f"/Users/weishuting/code/gitlab.sz.sensetime.com/cloud/new_apitest/apitest/image/ocr/business_license/performance_business_small.jpg"))
        # base64_image=str(BaseApi.imageToBase64(f"/Users/weishuting/code/gitlab.sz.sensetime.com/cloud/new_apitest/apitest/image/ocr/business_license/performance_business_big.jpg"))
        body={
                    "encrypt_info": {

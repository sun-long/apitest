...
if __name__=="__main__":
    #输入1--标注文件
    ground_truth_file="/Users/weishuting/scp/viper/data/银行卡/2023-1-3-送标文件/ground_truth.json"
    #输入2--素材
    test_image_file="/Users/weishuting/scp/viper/data/银行卡/2023-1-3-送标文件/test_image.json"
    #输入3--host

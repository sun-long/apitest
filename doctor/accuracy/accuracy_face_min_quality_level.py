...
class Accuracy:
    def __init__(self,config):
        ...
        #文件头
        self.excel_header=["测试数据","人脸标定质量等级","检出质量等级","等级设置为HIGH","等级设置为NORMAL","等级设置为LOW"]
        #汇总信息头
    ...
    def detect_run(self):
        ...
        #人脸入库
        #step1创建库
        min_quality_levels=["HIGH","NORMAL","LOW"]
        ...
        for image_path_t in video_paths_t:
            ...
            for key,v in value.items():
                if "low quality face" not in value:
                    value_last=v
...
if __name__=="__main__":
    #输入1--标注文件
    ground_truth_file="/Users/weishuting/scp/2023-3-21-人脸质量等级数据集/ground_truth.json"
    #输入2--素材
    test_image_file="/Users/weishuting/scp/2023-3-21-人脸质量等级数据集/test_image.json"
    #输入3--hostg

...
def generate_ground_truth(path_dir,ground_truth_file_name):
    ...
    ground_truth_data={}
    for i in fileList:
        ground_truth_data[i]={"card_number":"",
                              }
...
if __name__=="__main__":
    ...
    #统一文件夹名称
    # path_dir=f"/Users/weishuting/scp/viper/data/银行卡/2023-1-3-送标文件"
    # main_file_name=f"bankcard"
    # index=0
    # uniform_file_name(path_dir=path_dir,main_file_name=main_file_name,index=index)

    #生成初始ground_truth
    # path_dir=f"/Users/weishuting/scp/viper/data/银行卡/2023-1-3-送标文件"
    # ground_truth_file_name=f"/Users/weishuting/scp/viper/data/银行卡/2023-1-3-送标文件/ground_truth.json"
    # generate_ground_truth(path_dir=path_dir,ground_truth_file_name=ground_truth_file_name)

    #生成test_image文件
    path_dir=f"/Users/weishuting/scp/viper/data/银行卡/2023-1-3-送标文件-done"
    test_image_file_name=f"/Users/weishuting/scp/viper/data/银行卡/2023-1-3-送标文件-done/test_image.json"

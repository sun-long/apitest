...
def generate_ground_truth(path_dir,ground_truth_file_name):
    ...
    ground_truth_data={}
    for i in fileList:
        ground_truth_data[i]={"is_liveness":"",
                              }
...
if __name__=="__main__":
    ...
    #生成初始ground_truth
    path_dir=f"/Users/weishuting/scp/样本"
    ground_truth_file_name=f"/Users/weishuting/scp/样本/ground_truth.json"
    generate_ground_truth(path_dir=path_dir,ground_truth_file_name=ground_truth_file_name)

    #生成test_image文件
    # path_dir=f"/Users/weishuting/scp/样本"
    # test_image_file_name=f"/Users/weishuting/scp/样本/test_image.json"

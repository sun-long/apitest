...
if __name__=="__main__":
    ...
    #生成初始ground_truth
    path_dir=f"/Users/weishuting/code/belt-beta-new/doctor/resource/images/ids_image/ocr/vehicle_license"
    ground_truth_file_name=f"/Users/weishuting/code/belt-beta-new/doctor/resource/images/ids_image/ocr/vehicle_license/ground_truth.json"
    generate_ground_truth(path_dir=path_dir,ground_truth_file_name=ground_truth_file_name)

    #生成test_image文件
    # path_dir=f"/Users/weishuting/code/belt-beta-new/doctor/resource/images/ids_image/ocr/vehicle_license"
    # test_image_file_name=f"/Users/weishuting/code/belt-beta-new/doctor/resource/images/ids_image/ocr/vehicle_license/test_image.json"

...
def generate_ground_truth(path_dir,ground_truth_file_name):
    ...
    ground_truth_data={}
    for i in fileList:
        ground_truth_data[i]={"face_quality_level":"normal"}
...
if __name__=="__main__":
    ...
    #统一文件夹名称
    # path_dir=f"/Users/weishuting/scp/2023-3-21-人脸质量等级数据集/静默活体"
    # main_file_name=f"face"
    # index=0
    # uniform_file_name(path_dir=path_dir,main_file_name=main_file_name,index=index)

    #生成初始ground_truth
    # path_dir=f"/Users/weishuting/scp/2023-3-21-人脸质量等级数据集"
    # ground_truth_file_name=f"/Users/weishuting/scp/2023-3-21-人脸质量等级数据集/ground_truth.json"
    # generate_ground_truth(path_dir=path_dir,ground_truth_file_name=ground_truth_file_name)

    #生成test_image文件
    path_dir=f"/Users/weishuting/scp/2023-3-21-人脸质量等级数据集"
    test_image_file_name=f"/Users/weishuting/scp/2023-3-21-人脸质量等级数据集/test_image.json"

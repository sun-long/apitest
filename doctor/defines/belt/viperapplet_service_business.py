...
from defines.belt.api.viperapplet_service_swagger import ViperappletSwaggerApi
...
class ViperappletSwaggerBusiness(ViperappletSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(ViperappletSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)

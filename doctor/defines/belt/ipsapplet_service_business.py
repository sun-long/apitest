...
from defines.belt.api.ipsapplet_service_swagger import IpsappletSwaggerApi
...
class IpsappletSwaggerBusiness(IpsappletSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(IpsappletSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)
    ...
    def init_interface(self, inte_obj):
        ...
        inte_obj.set_headers('X-Object-Type', 'algo')
        inte_obj.set_headers('X-Object-Version', 'face-liveness-applet-10000')

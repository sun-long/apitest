...
from defines.belt.api.argusdatacenter_service_swagger import ArgusdatacenterSwaggerApi
...
class ArgusdatacenterSwaggerBusiness(ArgusdatacenterSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(ArgusdatacenterSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)
        self.TOKEN_NAME = "X-Belt-Signature"
        self.TOKEN_VALUE = "%s"  # token默认信息
        self.configMap = utils.readConfigMap("argus.yaml", "http://datacenter-hauler-srv.argus:10002")

...
from defines.belt.api.idsfaceserviceswagger_service_swagger import IdsFaceServiceSwaggerSwaggerApi
...
class IdsFaceServiceSwaggerSwaggerBusiness(IdsFaceServiceSwaggerSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(IdsFaceServiceSwaggerSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)

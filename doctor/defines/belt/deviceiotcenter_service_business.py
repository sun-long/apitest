...
from defines.belt.api.deviceiotcenter_service_swagger import DeviceiotcenterSwaggerApi
...
class DeviceiotcenterSwaggerBusiness(DeviceiotcenterSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(DeviceiotcenterSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)

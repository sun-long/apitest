...
class IpsocrSwaggerApi(BaseApi):
    """ web接口"""
    ...
    def BatchCustomTemplatePostApi(self, type=None, images=None, template_data=None, loginToken=None, sendRequest=True, print_log=True, interface_desc=None):
        ...
        """
        intef = collections.interface("ipsOcr", "BatchCustomTemplate")
...
[EN] Detection... """
        ...
        """
        intef = collections.interface("ipsOcr", "BatchPlainText")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
[EN] O... """
        ...
        """
        intef = collections.interface("ipsOcr", "BatchSpecialTemplate")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
... """
        ...
        """
        intef = collections.interface("ipsOcr", "BatchTemplate")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
[EN] Get system info which... """
        ...
        """
        intef = collections.interface("ipsOcr", "GetSystemInfo")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)

...
from defines.belt.api.argusrrs_service_swagger import ArgusrrsSwaggerApi
...
class ArgusrrsSwaggerBusiness(ArgusrrsSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(ArgusrrsSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)
        self.TOKEN_NAME = "X-Belt-Signature"
        self.TOKEN_VALUE = "%s"  # token默认信息
        self.configMap = utils.readConfigMap("argus.yaml", "http://argus-rrs.argus:8000")

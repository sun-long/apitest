...
from defines.nova.api.order_internal_service_swagger import Order_internalSwaggerApi
...
class Order_internalSwaggerBusiness(Order_internalSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(Order_internalSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)

...
class WalletSwaggerApi(BaseApi):
    """ web接口"""
    ...
    def NovaWalletService_GetAmountGetApi(self, loginToken=None, sendRequest=True, print_log=True, interface_desc=None):
        """  获取用户余额
route: prefix=console action=GetAmount vers... """
        """  path: [get]/console/v1/amount API """
        """  params: 
        ...
        """
        intef = collections.interface("Wallet", "NovaWalletService_GetAmount")

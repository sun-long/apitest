...
class InternalauthSwaggerApi(BaseApi):
    """ web接口"""
...
route: prefix=console-int... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminGetPhoneOrEmailByAccountID")
...
filled in response
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminGetAccountList")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console-inter... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminUpdateAccount")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console-internal ac... """
        ...
        """  params: 
                参数名称：account_id　类型：string　描述：账户I
        """
        """  resp:
                200(A successful response.):
                {
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminGetEnterpriseAccount")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
3 获取身份证号码未脱敏信息
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminGetEnterpriseAccountUnRedactedInfo")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console-internal action=Ad... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminUpdateAccountStatus")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console-internal action=Ad... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminBusinessAssignment")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console action=AdminGetI... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminGetIndustryInfo")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
filled in response
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminGetAccountUserList")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
filled in response
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminGetCostManagementAccountList")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
filled in response
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminGetInquiryAccountList")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console-internal act... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminListPolicyGroup")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console-i... """
        ...
        """  params: 
                参数名称：user_id　类型：string　描述：权限组名
        """
        """  resp:
                200(A successful response.):
                {
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminGetAllPolicyGroupsByUserID")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console action=CreateInter... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_CreateInternalUserWithAccount")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console-internal actio... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminGetUserBaseInfo")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console action=ConsoleInt... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_ConsoleInternalUpdateUserCellphone")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console actio... """
        ...
        """  params: 
                ...
                参数名称：value　类型：string　描述：邮箱/手机号 必
        """
        """  resp:
                200(A successful response.):
                {
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminSendSmsCode")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console actio... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminVerifySmsCode")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=con... """
        ...
        """  params: 
                参数名称：mode　类型：integer　描述：模式 0：邮箱 1：手机 必
        """
        """  resp:
                200(A successful response.):
                {
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_SendCurrentAdminUserSmsCode")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=cons... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_VerifyCurrentAdminUserSmsCode")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console-interna... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_AdminBatchAddPolicyGroupToUser")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
filled in response
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_GetWhitelistAccounts")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console-internal action=... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_CreateWhitelistAccount")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)
...
route: prefix=console-internal action=... """
        ...
        """
        intef = collections.interface("InternalAuth", "ConsoleInternalAuthService_DeleteWhitelistAccount")
        intef.set_print_log(print_log)
        intef.set_description(interface_desc)
        if loginToken:
            intef.set_headers(self.TOKEN_NAME, self.TOKEN_VALUE % loginToken)

...
from defines.nova.api.wallet_internal_service_swagger import Wallet_internalSwaggerApi
...
class Wallet_internalSwaggerBusiness(Wallet_internalSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(Wallet_internalSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)

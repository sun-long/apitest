...
from defines.nova.api.playground_service_swagger import PlaygroundSwaggerApi
...
class PlaygroundSwaggerBusiness(PlaygroundSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(PlaygroundSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)

...
from defines.nova.api.wallet_service_swagger import WalletSwaggerApi
...
class WalletSwaggerBusiness(WalletSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(WalletSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)

...
from defines.nova.api.internalauth_service_swagger import InternalauthSwaggerApi
...
class InternalauthSwaggerBusiness(InternalauthSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(InternalauthSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)

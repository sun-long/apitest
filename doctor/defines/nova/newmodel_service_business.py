...
from defines.nova.api.newmodel_service_swagger import NewmodelSwaggerApi
...
class NewmodelSwaggerBusiness(NewmodelSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(NewmodelSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)

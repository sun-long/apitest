...
from defines.nova.api.embedding_service_swagger import EmbeddingSwaggerApi
...
class EmbeddingSwaggerBusiness(EmbeddingSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(EmbeddingSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)

...
from defines.nova.api.stat_service_swagger import StatSwaggerApi
...
class StatSwaggerBusiness(StatSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(StatSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)

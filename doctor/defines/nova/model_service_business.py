...
from defines.nova.api.model_service_swagger import ModelSwaggerApi
...
class ModelSwaggerBusiness(ModelSwaggerApi):
    """ 业务类代码写在这里"""
    def __init__(self, host, token=None, config_obj=None, ext_info=None):
        super(ModelSwaggerBusiness, self).__init__(host, token, config_obj, ext_info)
